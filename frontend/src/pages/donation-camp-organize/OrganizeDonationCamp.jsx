				...
				<div className="w-full px-4 mt-[1rem]">
					...
					<div className="bg-gray-200 p-4 rounded-lg shadow-md">
						...
						<p className="text-lg text-gray-700">
							...
							<br />
							<strong>
								submit a permission letter from the relevant authority of the location where you will hold the blood
								campaign.
							</strong>
							<br />
							<br />
							As an example you gonna organize donation camp in the school main hall you need to get requested letter
							from principle.
						</p>
					</div>
				</div>
