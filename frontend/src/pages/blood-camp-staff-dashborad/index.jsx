      ...
      <div className="flex justify-center space-x-4 mt-8">
        <button
          ...
          className={`px-4 py-2 rounded-md ${
            view === "bloodCampAdmin" ? "bg-blue-500 text-white" : "bg-gray-200"
          }`}
        >
          Blood Camp Admin
        </button>
        <button
          ...
          className={`px-4 py-2 rounded-md ${
            view === "getAllCamps" ? "bg-blue-500 text-white" : "bg-gray-200"
          }`}
        >
          Get All Camps
        </button>
        <button
          ...
          className={`px-4 py-2 rounded-md ${
            view === "allDonors" ? "bg-blue-500 text-white" : "bg-gray-200"
          }`}
        >
          All Donors
        </button>
