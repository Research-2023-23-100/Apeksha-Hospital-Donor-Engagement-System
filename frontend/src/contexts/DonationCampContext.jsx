...
const DonationCampContext = createContext();

export const DonateCampProvider = ({ children }) => {
  ...
  return (
    <DonationCampContext.Provider value={{ camps, camp, createCamp, getAllCamps, getCampById, updateCamp, deleteCamp, setCamp }}>
      {children}
    </DonationCampContext.Provider>
  );
};

export default DonationCampContext;
