...
function DonorLogin() {
	...
	return (
		<div className="container mx-auto flex items-center justify-center mt-10">
			...
			<div className="bg-white p-8 rounded-lg shadow-md flex items-center justify-center w-full md:w-3/4 lg:w-1/2 ml-[5rem]">
				{/* Login form */}
				<div className="flex flex-col justify-center items-center w-full md:w-2/3 ">
					<h2 className="text-2xl font-semibold mb-4">Blood Donor Login</h2>
					<form className="w-full" onSubmit={handleSubmit}>
						...
						<button
							type="submit"
							className="bg-red-400 text-white px-6 py-2 rounded-lg font-semibold hover:bg-red-600 focus:outline-none focus:bg-red-600"
						>
							Login
						</button>
					</form>
			...
			{/* Carousel */}
			<div className="w-full md:w-1/4 lg:w-1/2 ml-8">
				<Carousel />
			</div>
		</div>
	);
